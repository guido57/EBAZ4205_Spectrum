...
{
public:
	static ExtIO_EBAZ::GUI^ gGUI = nullptr;
...
bool EXTIO_API InitHW(char* name, char* model, int& type)
{
	...
	if (!gInitHW)
	{
		...
		ManagedGlobals::gGUI = gcnew ExtIO_EBAZ::GUI;
...
extern "C"
void EXTIO_API SetCallback(void (*callback)(int, int, float, char*))
{
